...
```{r play type counts, warning = FALSE}
data_main %>% 
  group_by(play_type) %>% 
...
go_model = xgb.train(data = go_xgb_train, max_depth = 8,  colsample_bylevel = 1, colsample_bytree = 1, watchlist=kick_watchlist, nrounds = 500, verbose = 0, eta = 0.05, subsample = 0.7)
