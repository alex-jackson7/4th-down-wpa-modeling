...
punt_model = xgb.train(data = punt_xgb_train, max_depth = 6,  colsample_bylevel = 1, colsample_bytree = 0.8, watchlist=punt_watchlist, nrounds = 1000, verbose = 1, eta = 0.1, subsample = 0.9, lambda = 3)
punt_model_xgboost = xgboost(data = punt_xgb_train, max_depth = 6, nrounds = 433, colsample_bytree = 1, colsample_bylevel = 1, verbose = 0, eta = 0.1, subsample = 0.9)
...
go_model = xgb.train(data = go_xgb_train, max_depth = 6,  colsample_bylevel = 1, colsample_bytree = 1, watchlist=kick_watchlist, nrounds = 100, verbose = 0, eta = 0.1, subsample = 0.9)
...
pred_data = cbind(pred_data, play_type = data_main$play_type, team = data_main$posteam, year = data_main$year, punt_preds, kick_preds, go_preds) %>% 
