...
```{r count by decision, echo = FALSE, fig.width=4, fig.height=3, fig.align='center'}
...
```{r punt xgboost, fig.width=4, fig.height=3, fig.align='center', echo = FALSE}
set.seed(12321)
...
```{r kick xgboost, fig.width=4, fig.height=3, fig.align='center', echo = FALSE}
set.seed(12321)
...
```{r go xgboost model, fig.width=4, fig.height=3, fig.align='center', echo = FALSE}
go_data <- go_data %>% 
